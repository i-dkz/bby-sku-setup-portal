...
// this is the setup column component, columns are dynamically rendered based on selectedNum and all the columns make up a form
export default function SetupCol() {
